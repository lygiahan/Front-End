...
export default function TheHeader() {
  ...
  return (
    <nav className="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <div class="d-flex">
        <input class="form-control me-2" name="search" onChange={onChange} type="search" placeholder="Search" aria-label="Search"/>
        <button class="btn btn-outline-success" type="submit" onClick={()=>onSearch(data.search)}>Search</button>
      </div>
    </nav>
  );
}
